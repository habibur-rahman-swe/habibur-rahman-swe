...
const testimonialsItem = dcoument.querySelector("[data-testimonials-item]");
const modalContainer = dcoument.querySelector("[data-modal-container]");
const modalCloseBtn = document.querySelector("[data-modal-close-btn]");
const overlay = dcoument.querySelector("[data-ooverlay]");
